...
export class Guard {
  ...
  public static againstEmptyArray(argument: unknown[], argumentName: string): IGuardResult {
    return argument.length === 0 ? { succeeded: false, message: `${argumentName} is empty` } : { succeeded: true };
  }
